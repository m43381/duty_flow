...
- units: Всё, что связано с иерархией подразделений.

- ranks: Справочник воинских/специальных званий.

- people: Сотрудники (Person), их освобождения и допуски.

- duty_types: Справочник типов нарядов.

- duty_plans: Планирование нарядов и назначения.

- users_app: Пользователи-операторы, их профили и права.
